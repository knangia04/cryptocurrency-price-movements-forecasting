...
def process_data(df):
    ...
    df.drop(["COLLECTION_TIME", "MESSAGE_ID", "MESSAGE_TYPE", "SYMBOL",'BID_PRICE_1', 'ASK_PRICE_1', 'BID_PRICE_2', 'ASK_PRICE_2', 'BID_PRICE_3', 'ASK_PRICE_3','ASK_SIZE_1' , 'BID_SIZE_1' ,'ASK_SIZE_2' , 'BID_SIZE_2' , 'ASK_SIZE_3' , 'BID_SIZE_3'], axis=1, inplace=True)
    # Remove outliers from each column
    columns_to_check_outliers = ['MID_PRICE']
